        ...
        btn.addEventListener("click", function () {
          Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              const message = encodeURIComponent("Aku udah jawab 'Mauu banget! 😍' di web kamu hehe 😚");
              window.open(`https://wa.me/${phoneNumber}?text=${message}`, '_blank');
            } else {
              Swal.fire('Yahhh:(', 'Yauda gapapa deh... tapi aku sedih 😔', 'error');
              const message = encodeURIComponent("Aku jawab 'Enggak deh 😢' di web kamu... maaf yaa 😔");
              window.open(`https://wa.me/${phoneNumber}?text=${message}`, '_blank');
            }
          });
        });
