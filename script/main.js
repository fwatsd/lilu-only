      ...
      if (btn) {
        ...
        btn.addEventListener("click", function () {
          Swal.fire({
            ...
            html: '<strong>Do u want to be mine until SOK MBEN?</strong>',
            icon: 'question',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire('Yeyyy!', 'Lelll??? Cihuyyyy Legall❤', 'success');

              // Kirim ke WhatsApp
              const phoneNumber = "6281285026909";
              const message = encodeURIComponent("Aku jawab 'Mauu banget! 😍' heheee 😚");
              ...
              // Kirim ke WhatsApp
              const phoneNumber = "6281285026909";
              const message = encodeURIComponent("Aku jawab 'Enggak deh 😢' maaf yaa 😔");
              const whatsappURL = `https://wa.me/${phoneNumber}?text=${message}`;
              window.open(whatsappURL, '_blank');
            }
          });
